...
long thread_num = 8;//set threads number
 ...
 */
void Usage(char* prog_name) {
   fprintf(stderr, "usage: %s <number of toss> \n", prog_name);
   fprintf(stderr, "   number of toss should be >= 1\n");
   exit(0);
}  /* Usage */
